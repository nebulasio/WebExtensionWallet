...
var i18n = function () {
    var table = {
        ...
        zh: {
            ...
            "send-nas/balance": "余额",
            "send-nas/tips/risk": "风险操作",
            "send-nas/tips/text": "风险操作，被授权的地址可以直接划转您的NRC20资产",
        ...
        ko: {
            ...
            "header/check": "새로고침",
            "header/close": "닫기",
            "header/refresh_button": "트랜잭션 확인",
            "header/check_text": "트랜잭션 확인",
            "header/contract": "컨트랙트",
            "header/new-wallet": "새 지갑",
            "header/send": "트랜잭션 전송",
            ...
            resources: "리소스",
            "send-nas/amount": "전송할 양",
            "send-nas/balance": "잔액",
            "send-nas/button/generate": "승인",
            "send-nas/button/reject": "거부",
            "send-nas/button/rejectAll": "모두 거부",
            "send-nas/check": "제출",
            "send-nas/close": "닫기",
